% %
% Computerised measurement books for effective public works accounting Ver-D1.1
%
...
\begin{document}
	...
	\section{Introduction}
	 ...
	 \begin{enumerate}
	 	...
	 	\begin{noteblock}{Tips!}
		 		Pressing \fbox{\emph{Ctrl}} will deselect all rows.
		 		
		 		Cycle through rows horizontally using \fbox{\emph{Tab}} / \fbox{\emph{Shift}}+\fbox{\emph{Tab}} (forward/backward).
		 		
		 		Cycle through rows vertically using \fbox{\emph{Enter}} / \fbox{\emph{Shift}}+\fbox{\emph{Enter}} (up/down).
