...
latex_item = r"""
                ...
                \begin{longtabu} to \textwidth {|X[1,c]|X[10,l]|X[3,r]|X[3,r]|X[3,r]|X[3,r]|X[3,r]|X[5,r]|}
                   \hline
                    \textbf{Sl.\newline No.} & \textbf{Description} & \textbf{Lights} & \textbf{Fans} & \textbf{Ex.Fans} & \textbf{Call Bells} & \textbf{Other} & \textbf{Total} \\
                   \hline
                    \endhead
                $cmbrecords$
                    \hline
...
class CustomItem:
    def __init__(self):
        ...
        self.dimensions = [[300,80,80,80,80,80,100], [True,False,False,False,False,False,False]]
